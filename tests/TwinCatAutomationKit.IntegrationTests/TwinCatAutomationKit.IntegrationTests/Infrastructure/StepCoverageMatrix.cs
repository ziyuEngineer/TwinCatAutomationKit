...
internal static class StepCoverageMatrix
{
    ...
    [
        ...
        Spec("engineering.build-solution", "ordered-step-surface", "PLC-only runtime clone", "BuildCurrentSolution returns Succeeded=true and LastBuildInfo=0, then PLC .tmc/.compileinfo output files must exist."),
        ...
        Spec("tsproj.bind-plc-instance-task", "ordered-step-surface", "PLC instance, runtime task ObjectId", "PLC context ManualConfig XML points at exact RuntimeTask ObjectId and runtime ADS InitSymbol proof uses it."),
